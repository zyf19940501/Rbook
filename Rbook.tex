...
本文是个人学习数据处理相关R包的笔记，主要从\texttt{tidyverse}系列以及\texttt{data.table}两套语法做数据处理的笔记。我在R中字符处理使用\texttt{stringr}包，日期时间计算用\texttt{lubridate}包。
...
R中日期 : 2021-05-18 转化成数字: 18765,
Excel 中 2021-05-18转化成数字:44333,两者相差25568.
...
\hypertarget{ux5b89ux88c5-8}{%
\subsection{安装}\label{ux5b89ux88c5-8}}
