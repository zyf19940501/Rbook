...
本文主要记录个人学习数据处理相关R包的过程，主要从\texttt{tidyverse}系列以及\texttt{data.table}两套语法做数据处理笔记。关于字符以及时间用\texttt{stringr}以及\texttt{lubridate}两个包处理。

\textbackslash begin\{center\}\includegraphics[width=0.7\linewidth]{Rbook_files/figure-latex/unnamed-chunk-3-1}
...
\hypertarget{ux6570ux636eux5bfcux5165ux5bfcux51fa}{%
\chapter{数据导入导出}\label{ux6570ux636eux5bfcux5165ux5bfcux51fa}}
...
在本章开始前，假定已经有一些R相关基础。如使用Rstudio查看导入的数据，R的数据结构等有一定认识。
...
\hypertarget{rstudioux5bfcux5165}{%
\section{Rstudio导入}\label{rstudioux5bfcux5165}}
...
\hypertarget{ux6587ux4ef6ux8defux5f84}{%
\section{文件路径}\label{ux6587ux4ef6ux8defux5f84}}
...
R中日期 : 2021-05-17 转化成数字: 18764,
Excel 中 2021-05-17转化成数字:44332,两者相差25568.
